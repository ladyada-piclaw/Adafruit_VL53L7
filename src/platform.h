...
uint8_t RdByte(VL53L7CX_Platform* p_platform, uint16_t RegisterAdress,
               uint8_t* p_value);
...
uint8_t WrByte(VL53L7CX_Platform* p_platform, uint16_t RegisterAdress,
               uint8_t value);
...
uint8_t RdMulti(VL53L7CX_Platform* p_platform, uint16_t RegisterAdress,
...
uint8_t WrMulti(VL53L7CX_Platform* p_platform, uint16_t RegisterAdress,
                uint8_t* p_values, uint32_t size);
